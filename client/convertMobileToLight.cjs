...
function processFile(path) {
    ...
    text = text.replace(/text-white\b/g, 'text-slate-800'); // only whole word
    text = text.replace(/text-white/g, 'text-slate-800');
...
processFile('src/site-engg/components/mobile/MobileAdminDashboard.tsx');
processFile('src/site-engg/components/mobile/MobileEngineerDashboard.tsx');
processFile('src/site-engg/components/mobile/MobileHRDashboard.tsx');
processFile('src/site-engg/components/mobile/MobileClientDashboard.tsx');

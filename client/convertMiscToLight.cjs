...
processFile('src/site-engg/components/mobile/MobileClientWiseView.tsx');
processFile('src/site-engg/components/mobile/CheckInCard.tsx');
processFile('src/site-engg/components/Login.tsx');
